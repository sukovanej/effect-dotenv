...
export const makeConfigProvider = (
  ...
  Effect.gen(function*(_) {
    ...
    const obj = yield* Effect.sync(() => parse(content))
    return ConfigProvider.fromJson(obj)
  })

/** @internal */
export const layer = (path: string): Layer.Layer<never, PlatformError, FileSystem.FileSystem> =>
  makeConfigProvider(path).pipe(
